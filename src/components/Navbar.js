      ...
      <header className="w-full px-32 py-4 font-medium flex gap-20 justify-end items-center dark:text-light relative">
        ...
        {isOpen ? (
          <motion.div
            ...
            className="flex flex-col z-30 min-w-[70vw] justify-between items-center fixed top-1/3 left-1/2 -translate-x-[50%] -translate-y-1/2  bg-dark/40 text-light  dark:bg-light/75 dark:text-light rounded-lg backdrop-blur-md p-20"
          >
